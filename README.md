...
Edge AI lab demos: keysnooper (acoustic side-channel classification) and boxing trainer.
...
and released under the GPL (as per the LICENSE file).  Any other licenses that apply are indicated in respective source.
